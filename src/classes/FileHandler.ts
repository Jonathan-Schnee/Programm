...
export class FileHandler {
  ...
  public writeFile(pathToFile: string, dataToWrite: any): void {
    fs.writeFileSync(path.resolve(__dirname, "../" + pathToFile), JSON.stringify(dataToWrite, null, 4));

  }

  public exists(pathToFile: string): boolean {
    return fs.existsSync(path.resolve(__dirname, "../" + pathToFile));
  }
}